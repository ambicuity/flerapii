...
## Purpose
Provide a unified management experience for self-hosted **Done Hub** instances inside Flerapii, comparable to the existing managed-site support for New API (channel management, model sync, and model redirect).
