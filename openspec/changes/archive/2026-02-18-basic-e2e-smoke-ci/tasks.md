...
- [x] 2.1 Add a smoke test that opens `chrome-extension://<id>/popup.html` and asserts the page bootstraps (root non-empty, title contains `Flerapii`)
- [x] 2.2 Add a smoke test that opens `chrome-extension://<id>/options.html` and asserts the page bootstraps (root non-empty, title contains `Flerapii`)
