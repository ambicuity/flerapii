...
const BalanceDisplay: React.FC<{
  ...
  const sizeClass =
    size === "md"
      ? "text-[2rem] leading-none sm:text-[2.2rem]"
      : "text-[3.25rem] leading-none sm:text-[3.8rem]"
...
export default function AccountBalanceSummary() {
  ...
  return (
    <div className="space-y-3">
      <div className="subtle-surface rounded-[1.5rem] p-4">
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-2">
            <Caption className="font-semibold tracking-[0.14em] text-slate-400 uppercase dark:text-slate-500">
          ...
          <span className="ui-kbd">{currencyType}</span>
        </div>
      </div>
      ...
      {showTodayCashflow && (
        <div className="grid grid-cols-2 gap-3">
          <div className="subtle-surface rounded-[1.5rem] p-4">
            <Caption className="font-semibold tracking-[0.12em] text-slate-400 uppercase dark:text-slate-500">
