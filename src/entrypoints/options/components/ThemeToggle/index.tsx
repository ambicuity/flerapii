...
const ThemeToggle = () => {
  ...
  return (
    <CardItem
      ...
      rightContent={
        <div className="subtle-surface flex flex-col rounded-[1.15rem] p-1.5 shadow-none sm:flex-row">
      ...
      leftContent={
        <Caption className="mt-1 text-slate-500 transition-colors dark:text-slate-400">
