/**
 * Shared utilities for Flerapii content-script UIs.
 *
 ...
 */
export const CONTENT_UI_HOST_TAG = "flerapii-redemption-toast"
...
export function isEventFromAllApiHubContentUi(
  ...
  // <flerapii-redemption-toast data-wxt-shadow-root="">
