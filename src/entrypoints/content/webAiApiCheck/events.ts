...
export const API_CHECK_OPEN_MODAL_EVENT = "flerapii:api-check:open-modal"
export const API_CHECK_MODAL_CLOSED_EVENT = "flerapii:api-check:closed-modal"
export const API_CHECK_MODAL_HOST_READY_EVENT =
  "flerapii:api-check:modal-host-ready"
