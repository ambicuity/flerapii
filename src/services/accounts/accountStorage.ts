...
class AccountStorageService {
  ...
  async addAccount(
    ...
    try {
      logger.info("", { siteName: accountData.site_name })
  ...
  async deleteAccount(id: string): Promise<boolean> {
    try {
      ...
      logger.error("", { accountId: id, error })
      throw error //
    }
  }
  ...
  async deleteAccounts(ids: string[]): Promise<{ deletedCount: number }> {
    ...
    try {
      ...
      logger.error("", { accountIds: uniqueIds, error })
      throw error
    }
  }
  ...
  async setPinnedListSubset(input: {
    ...
    try {
      ...
      logger.error("", { entryType: input.entryType, error })
      return false
    }
  }
  ...
  async refreshAccount(
    ...
    try {
      ...
      try {
        ...
        logger.error("", { accountId: id, error: updateError })
      }
      return null
    }
  }
  ...
  private async saveAccounts(accounts: SiteAccount[]): Promise<void> {
    logger.debug("", { accountCount: accounts.length })
  ...
  async getBookmarkById(id: string): Promise<SiteBookmark | null> {
    ...
    try {
      ...
      logger.error("ID", { bookmarkId: id, error })
      return null
    }
  }
  ...
  async updateBookmark(
    ...
    try {
      ...
      logger.error("", { bookmarkId: id, error })
      return false
    }
  }
