 ...
 * 4.
 * @param url
 * @param authType Cookie / AccessToken / None
 */
 ...
 *
 * @param params
 * @param params.siteName
 * @param params.username
 * @param params.userId  ID
 * @param params.siteType
 * @param params.authType
 * @param params.accessToken
 * @param params.cookieAuthSessionCookie Cookie  CookieHeader
 * @param params.exchangeRate
 * @returns
 */
