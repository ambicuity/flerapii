 ...
 */
export const PROGRAM_NAME = "flerapii"
 ...
 *
 * Supported inputs:
 * - Full file URL (e.g. `.../flerapii-backup/flerapii-1-0.json`)
 * - Directory-like URL (e.g. `.../webdav/`) which will be expanded to a
 *   deterministic filename under `flerapii-backup/`.
 */
...
function getBackupDirUrl(targetUrl: string) {
  // derive the .../flerapii-backup/ directory from final target URL
 ...
 * `flerapii-backup/` is generated automatically.
 *
