          ...
          <div className="min-w-0 flex-1 space-y-2">
            ...
            <div className="space-y-2 text-xs">
              <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2">
                ...
                <code
                  className="dark:bg-dark-bg-tertiary dark:text-dark-text-secondary min-w-0 truncate rounded bg-gray-100 px-2 py-1 font-mono text-[10px] text-gray-800 sm:text-xs"
                ...
                <code
                  ...
                  title={
                    visibleKeys.has(profile.id)
                      ? profile.apiKey
                      : t("apiCredentialProfiles:list.apiKeyHidden")
                  }
                >
