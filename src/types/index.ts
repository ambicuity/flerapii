...
export interface AccountInfo {
  ...
  username: string
  quota: number //
  today_prompt_tokens: number //  prompt_tokens
  today_completion_tokens: number //  completion_tokens
  today_quota_consumption: number //  quota
  today_requests_count: number //
  today_income: number //  (recharge + check-in)
}
...
export interface ApiToken {
  ...
  group?: string //
  DeletedAt?: null
  models?: string //  models  model_limits
}
