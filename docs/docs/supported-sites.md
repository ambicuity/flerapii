...
> Flerapii primarily supports two types of objects: the intermediate stations/management panels you use daily, and backend systems you build yourself that you wish to continue managing within the plugin.

## Sites That Can Be Added and Managed Daily

The following are the most common and suitable types of sites for unified management through Flerapii.
...
If you are also building your own backend system, Flerapii supports importing the current site into your chosen backend for continued management.
