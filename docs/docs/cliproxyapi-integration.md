...
-   In Flerapii, the following has been completed:
...
-   This means:
    ...
    -   Flerapii is responsible for synchronizing basic configuration information, and subsequent details can be customized within CLIProxyAPI.
...
-   It can be used in conjunction with Flerapii's **Quick Export** feature to synchronize the same batch of upstream sites to various downstream systems such as New API / CLIProxyAPI.
