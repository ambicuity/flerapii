...
2. Fill in:
   - **Server Address**: Can point to a directory or a specific JSON file; if a directory is entered, `flerapii-backup/flerapii-1-0.json` will be automatically created under it.
...
2. When synchronization is performed:
   ...
   - Generate new JSON and upload it to `flerapii-backup/flerapii-1-0.json`.
